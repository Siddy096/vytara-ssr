  ...
  <div className="relative">
    ...
    <div className="relative z-10 bg-transparent"></div>
        ...
        <div className="px-4 pt-12 pb-8 max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-600 italic text-sm mt-4">Vytara is your one stop destination to have full control over your medical status and care for your loved one's wellness better</p>
        </div>
